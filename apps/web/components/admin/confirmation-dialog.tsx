  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-slate-950/50 p-4">
      <section
        ...
        aria-modal="true"
        className="flex max-h-[calc(100dvh-2rem)] w-full max-w-md flex-col overflow-hidden rounded-md border border-slate-200 bg-white shadow-xl"
        role="dialog"
      >
        ...
        <div className="mt-5 flex shrink-0 justify-end gap-2 border-t border-slate-100 px-5 py-4">
          <button
