...
export function OrderImportClient({ token, products, institutions }: OrderImportClientProps) {
  ...
  const [sourceTab, setSourceTab] = useState<"FILE" | "API">("FILE");
    ...
    <main className="min-h-screen bg-slate-50 px-6 py-8 text-slate-900">
      <section className="mx-auto max-w-5xl">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-slate-600">
              Escolha entre importar um arquivo ou consultar diretamente uma integra̤̣o de vendas.
            </p>
          </div>
          <a
        ...
        <nav
          ...
          role="tablist"
          aria-label="Origem da importa̤̣o"
        >
          <ImportSourceTab
            active={sourceTab === "FILE"}
            controls="file-import-panel"
            onClick={() => setSourceTab("FILE")}
          >
            Arquivo
          </ImportSourceTab>
          <ImportSourceTab
            active={sourceTab === "API"}
            controls="api-import-panel"
        ...
        <div
          id="api-import-panel"
          role="tabpanel"
          aria-label="Importa̤̣o por API"
          hidden={sourceTab !== "API"}
        >
        ...
        <div
          ...
          role="tabpanel"
          aria-label="Importa̤̣o por arquivo"
          hidden={sourceTab !== "FILE"}
        >
          <form
